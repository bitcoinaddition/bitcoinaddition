...
# Create zip file of binaries
	cp BTCA/src/btcad BTCA/src/btca-cli BTCA/src/btca-tx BTCA/src/qt/btca-qt .
	zip BTCA-Linux.zip btcad btca-cli btca-tx btca-qt
	rm -f btcad btca-cli btca-tx btca-qt
