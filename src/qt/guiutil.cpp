...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter BTCA address (e.g. %1)").arg("7mphVWRT43hdZ9zncvPRgA94tuL2dvFXCL"));
...
{
    // return if URI is not valid or is no BTCA: URI
...
bool openConfigfile()
{
    ...
    /* Open btca.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Btca.lnk";
}
...
{
    return GetAutostartDir() / "btca.desktop";
}
