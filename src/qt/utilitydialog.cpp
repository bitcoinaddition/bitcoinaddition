                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BTCA") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitcoinAddition is shutting down...") + "<br /><br />" +
        tr("Do not shut down the computer until this window dibtcaears.")));
    setLayout(layout);
}
