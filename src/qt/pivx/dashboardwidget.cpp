    ...
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelMessage->setText(tr("Amount of BTCA earned via Staking & Masternodes"));
    ...
    ui->labelAmountPiv->setText("0 BTCA");
	ui->labelAmountMNRewards->setText("0 BTCA");
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair BTCA, zBTCA
...
void DashboardWidget::onChartRefreshed()
{
    ...
    // init sets
    set0 = new QBarSet("BTCA");
	set1 = new QBarSet("BTCA MN Rewards");
