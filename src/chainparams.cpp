...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (    1, uint256("000003967fcdedb198509194bc634259e9d3dae8fbc4f39fbab1118c243b9ee1"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1619415910, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        assert(consensus.hashGenesisBlock == uint256("0x000000fe0f6f6f7f005bb1373daebbff98b69a2c2376efb7ea9b86ce4bea7d72"));
        ...
        consensus.nTargetTimespanV2 = consensus.nTargetTimespan * 30;
        consensus.nTargetSpacing = 1 * 60;
        consensus.nTimeSlotLength = 15;

        // spork key
        consensus.strSporkPubKey ="049bdce9639a10c815c3d9213b77401512046031b73e78ef880e9e4abedc28c665da7a04eb5c98b3e8685cf7782ec45cd431e6dec8fe575b6ac7cdd5109812e10f";
        ...
        consensus.height_new_client = disabled; //------- Height to be set at compile of Phase2 wallets ----------//

        // validation by-pass
        consensus.nPivxBadBlockTime = disabled;
        consensus.nPivxBadBlockBits = 0x1c008951;
        ...
        consensus.ZC_TimeStart = 1593067522;        // Genesis time - Not activated untill  # consensus.height_start_ZC
        ...
        vSeeds.push_back(CDNSSeedData("185.181.11.245", "185.181.11.245"));
        vSeeds.push_back(CDNSSeedData("185.181.9.39", "185.181.9.39"));
        vSeeds.push_back(CDNSSeedData("185.181.9.146", "185.181.9.146"));
        vSeeds.push_back(CDNSSeedData("194.37.81.60", "194.37.81.60"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 25); //address start letter 'S'
        base58Prefixes[TESTNET_PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); 
        base58Prefixes[KYAN_PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 26); //address start letter 'K'
        base58Prefixes[KYAN_TESTNET_PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 85); //address start letter 'k'
        ...
        strMasternodePoolDummyAddress = "EWaFb6QmUASw2YAcJe2Gjpd1oscyaPQDzU";
    }
